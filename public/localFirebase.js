...
//------------------------------------------------------------------------------
  ...
  this.addedValue = this.addedValue.bind(this);
  pushPage.querySelector('input.paragraphRes').addEventListener('input', this.addedValue);

  function addedValue() {
    pushPage.querySelector('button#submit').classList.add('loginColor');
  }
...
function initiateMessaging() {
  ...
  messaging.requestPermission().then(function() {
    ...
    //send this token to the server attached to this user 
  }).catch(function(err) {
